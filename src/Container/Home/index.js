    ...
    <div className="container-principal">
      ...
      <div className="container-secundario">
        <div  className="Div-Conteudo">
          <div className="icons">
            <FaArrowAltCircleUp   onClick={()=>setMinutesWork(minutesWork+1) }/>
        ...
        <div  className="Div-Conteudo">
          <div className="icons">
          <FaArrowAltCircleUp   onClick={()=>setMinutesRest(minutesRest+1) }/>
            <FaArrowAltCircleDown onClick={()=>{
              if(minutesRest > 1){
        ...
        <div className="Div-Conteudo">
          <div className="icons">
          <FaArrowAltCircleUp   onClick={()=>setSessionLoop(sessionLoop+1) }/>
            <FaArrowAltCircleDown  onClick={()=>{
              if(sessionLoop > 1){
      ...
      <Link to={`/time/?minutes=${minutesWork}&rest=${minutesRest}&session=${sessionLoop} ` }  >
